...
@section('title')Administrator Edit {{ $post->title }} @endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <form method="POST" action="{{ route('adminPostEdit', $post->id) }}">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="col-md-8" align='center'>
                                <button type="submit" class="btn btn-primary">Update Post&nbsp;<i class="icon icon-arrow-up-circle"></i></button>
                            </div>  
                        </div>
                    </form>  
                </div>
